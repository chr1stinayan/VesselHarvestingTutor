...
class VesselHarvestingTutorLogic(ScriptedLoadableModuleLogic):
  ...
  def loadTransforms(self):
    ...
    retractorToCutter = slicer.util.getNode('RetractorToCutter')
    if retractorToCutter == None:
      retractorToCutter = slicer.vtkMRMLLinearTransformNode()
      retractorToCutter.SetName('RetractorToCutter')
      slicer.mrmlScene.AddNode(retractorToCutter)
  ...
  def updateTransforms(self, event, caller):
    ...
    print triggerToCutterTransform
